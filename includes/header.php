        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item <?= ($current_page == 'showOrderForm') ? 'active' : '' ?>">
                    <a class="nav-link" href="showOrderForm"><i class="fas fa-shopping-cart"></i> Đặt hàng</a>
                </li>
                <li class="nav-item <?= ($current_page == 'user_orders') ? 'active' : '' ?>">
                    <a class="nav-link" href="user_orders"><i class="fas fa-history"></i> Lịch sử đặt hàng</a>
                </li>
                ...
                <?php if ($user): ?>
                    <li class="nav-item ml-auto <?= ($current_page == 'profile') ? 'active' : '' ?>">
